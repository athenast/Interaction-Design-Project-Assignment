...
Απεκόνηση πώς θα το είχαμε ράψει
-------------------------
** Αφου εννώσαμε ένα LED, τον αισθητήρα και το Lilypad ο αιασθητήρας ξεκίνησε να ζεσταίνεται αρκετά και να μοιρίζει καμένο.<br>
Οι άκρες στο καλώδιο-κλωστή που ενωνόταν στο - του Lilypad και στο Y του αισθητήρα φαινόταν να βγάζει ναι καίγεται σιγα σιγά (μικρές σπίθες). <br>
Γι αυτό το ξυλώσαμε και φτιάξαμε μια ψηφιακή απεικόνηση που δείχνει πως θα ράυαμε το κάθε κομμάτι μεταξύ του. <br>

![our_example](https://user-images.githubusercontent.com/101419410/173049870-b27b9733-9747-4eea-b8f9-333dc8c4b250.jpg)


Ένδειξη Performance ...
-------------------------
Δυστυχώς δεν καταφέραμε να υλοποιήσουμε το performance και να το παρουσιάσουμε σε μορφή βίνετο. <br>
Γι αυτό βγάλαμε μια φωτογραφία για να δείξουμε το ΡΟΥΧΟ και την εικόνα που θέλαμε να παρουσιάσουμε με την βοήθεια του Lilypad. <br>
